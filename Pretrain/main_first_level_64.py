...
from utils.data_utils_first_level_64 import get_loader
...
def main():
    ...
    if args.model_name == "deepunet_v2_64_32":
        from pretrain_models.deep_unet_v2_64_32 import DeepUNet
        model = DeepUNet(1, 1, features=[64, 64, 128, 256, 512], 
                        pool_size=((2, 2, 2), (2, 2, 2), (2, 2, 2), (1, 1, 1)), 
                        select_reconstruct_region=[[0, 0, 0], [16, 16, 16]],
                        dropout=0.15,
                        pretrain=True)

    elif args.model_name == "deepunet_v2_64_16":
        from pretrain_models.deep_unet_v2_64_16 import DeepUNet
        model = DeepUNet(1, 1, features=[64, 64, 128, 256, 512], 
                        pool_size=((2, 2, 2), (2, 2, 2), (2, 2, 2), (1, 1, 1)), 
                        select_reconstruct_region=[[0, 0, 0], [16, 16, 16]],
                        dropout=0.5,
